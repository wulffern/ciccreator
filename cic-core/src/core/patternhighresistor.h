...
#ifndef CIC_CORE_PATTERNHIGHRESISTOR_H
#define CIC_CORE_PATTERNHIGHRESISTOR_H
...
namespace cIcCore{
    ...
    class PatternHighResistor : public PatternTile
    {
        Q_OBJECT
...
Q_DECLARE_METATYPE(cIcCore::PatternHighResistor)
