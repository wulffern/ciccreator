...
#ifndef CIC_CORE_PATTERNHIGHRESISTORNOBULK_H
#define CIC_CORE_PATTERNHIGHRESISTORNOBULK_H
...
namespace cIcCore{
    ...
    class PatternHighResistorNoBulk : public PatternTile
    {
        Q_OBJECT

    public:
        virtual void paintRect(Rect*, QChar ,int , int );
        PatternHighResistorNoBulk();
        PatternHighResistorNoBulk(const PatternHighResistorNoBulk& mos);
        ~PatternHighResistorNoBulk();
...
Q_DECLARE_METATYPE(cIcCore::PatternHighResistorNoBulk)
